...
describe('Advanced-xpath locator strategies', () => {
     ...
     */
    it.only('Verify current temp is in between 30 and 50', async () => {
        // 1. Launch https://www.google.com/
        ...
        // 3. Verify current-temp is between 40 and 50
        const currentTempLocator = '//span[@id="wob_tm"]';
        ...
        expect(currentTemp > 30 && currentTemp < 50, 'Current temp is NOT in between 40 and 50').to.be.true;
    ...
    it('Verify user gets error when does not mention gender', async () => {
        ...
        expect(isErrorDisplayed, 'Gender error is NOT displayed').to.be.true;
