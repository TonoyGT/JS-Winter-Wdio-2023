 ...
 */
    ...
    it.only('Verify the travelers count on homepage', async () => {
        ...
        /*console.log('Room1=', room1AdultsNum);
        console.log('Room2=', room2AdultsNum);
        console.log('TT=', totalTravelersValue);
        console.log('TT=', totalTravelersNum);
        console.log('TT=', roomTotal);
        */
